...
10. Open the `Profile Match` tab and show the overall score, progress bar, category score breakdown, and category reasons.
11. In `Profile Match`, show strong matches, partial matches, missing skills, and evidence by skill.
12. Open the `Skill Gaps` tab and show prioritized recommendations.
