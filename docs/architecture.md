...
The same Mermaid source is available as `assets/architecture/devpath-agent-architecture.mmd` for rendering into a PNG if needed for the Kaggle Media Gallery.
